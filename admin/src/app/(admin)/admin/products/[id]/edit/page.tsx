...
export default function EditProductPage() {
    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[1.1rem] font-bold text-gray-900">Loading product...</p>
        </div>
      </div>
    );
  }
  ...
  if (!currentProduct) {
    return (
      <div className="flex min-h-[60vh] items-center justify-center">
        <div className="text-center p-8 rounded-[32px] bg-white border border-gray-100 shadow-sm">
          <p className="text-[1.1rem] font-bold text-red-500">Product not found</p>
          <Button onClick={() => router.push('/admin/products')} className="mt-6 w-full">
    ...
    <>
      ...
      <div className="space-y-8 pb-20">
        ...
        >
          ...
          <div>
            <h1 className="text-[1.8rem] font-black text-gray-900 tracking-tight">Edit Product</h1>
            <p className="text-[0.95rem] font-medium text-gray-500 mt-1">
              Update information for <span className="font-bold text-emerald-600">{currentProduct.name}</span>
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-6">
            ...
            >
              {isUploading ? 'Finalizing uploads...' : 'Save Product Changes'}
            </Button>
          </div>
        </motion.form>
      </div>
