...
const menuItems: MenuItem[] = [
  ...
  { 
    id: 'm10', 
    name: 'Somosa', 
    description: 'Crispy pastry filled with your choice of meat or vegetables', 
    price: 3.80, 
    image: '/images/starters.png', 
    images: ['/images/starters.png'], 
    ingredients: ['Pastry', 'Spices', 'Vegetable Oil'], 
    categoryId: 'c2',
    options: [
      { name: 'Filling', choices: ['Meat', 'Vegetable'], required: true }
    ]
  },
  ...
  { 
    id: 'm6', 
    name: 'Chicken Balti', 
    description: 'Cooked with fresh tomatoes, garlic and coriander', 
    price: 8.90, 
    image: '/images/balti.png', 
    images: ['/images/balti.png', '/images/starters.png'], 
    ingredients: ['Chicken', 'Tomatoes', 'Garlic', 'Coriander', 'Balti Paste', 'Onions'], 
    categoryId: 'c3',
    options: [
      { name: 'Spice Level', choices: ['Mild', 'Medium', 'Hot'], required: true }
    ]
  },
